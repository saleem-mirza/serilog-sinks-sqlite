...
namespace Serilog.Sinks.SQLite.Data
{
    /// <summary>
    /// A wrapper class for <see cref="Events.LogEvent"/> that is used to store as a document in SQLite.
    /// </summary>
    public class LogEvent
    {
        ...
        public LogEvent(Events.LogEvent logEvent, string renderedMessage, bool storeTimestampInUtc)
        {
            ...
            {
                Properties.Add(pair.Key, SQLitePropertyFormatter.Simplify(pair.Value));
            }
        }
